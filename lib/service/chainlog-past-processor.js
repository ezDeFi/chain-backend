...
const { _validateAssistedJsonRpcProvider } = require('../validator')
...
const chainlogPastProcessor = ({configs, consumers, mongoose, indexerEndpoint}) => {
    ...
    return {
        ...
        process: async () => {
            ...
            const maxRange = fetcher || _validateAssistedJsonRpcProvider(configs.partition.getProvider()) ? Number.MAX_VALUE : concurrency * config.getSize()
